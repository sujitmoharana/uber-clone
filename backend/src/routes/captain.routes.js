...
router.post('/register',[
    ...
    body('vechile.color').isLength({min:3}).withMessage("captain firstname must be atleast 3 character as long"),
    body('vechile.plate').isLength({min:3}).withMessage("captain firstname must be atleast 3 character as long"),
    body('vechile.capacity').isLength({min:1}).withMessage("captain firstname must be atleast 1 character as long"),

...
const Watingfordriver = ({setWaitingfordriver,waitingfordriverref}) => {
  return (
    <div ref={waitingfordriverref} className='bottom-0 absolute bg-white w-full p-2 translate-y-full '>
    <div className='flex items-center justify-between'>
  <h5 className='text-2xl font-bold'>Looking for drivers</h5>
  <h3 className='text-2xl'  onClick={()=>setWaitingfordriver(false)}>

...
const Confromrides = ({setVechilefound,setVehiclepanel,setConfronridespanel,confromridepanelref}) => {
  return (
    <div ref={confromridepanelref} className='bottom-0 absolute bg-white w-full p-2 translate-y-full '>
      <div className='flex items-center justify-between'>
    <h5 className='text-2xl font-bold'>Confrom your ride</h5>
    <h3 className='text-2xl'  onClick={()=>setConfronridespanel(false)}>
